...
class AdaptiveTradingSystemGUI:
    ...
    def start_gui(self, use_web_gui=False):
        """Start Enhanced GUI - Config & Connect only"""
        try:
            logger.info("🖥️ Starting Enhanced GUI (Config & Connect)")
